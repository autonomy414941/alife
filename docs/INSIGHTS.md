...
- Compact uncertainty sweep on 2026-03-06 (`runs=2`, `seedBlocks=3`, `intervals={20,24}`, `phases={0,0.25}`) had no supported cells; `interval=24, phase=0.25` remained near-zero (`mean=-0.077`, `CI=[-0.210,+0.057]`).
