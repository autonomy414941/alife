...
export class LifeSimulation {
  ...
  private pickOffspringSettlement(
    ...
    if (!this.config.offspringSettlementEcologyScoring && lineagePenalty === 0 && !this.usesEncounterRiskAversion()) {
    ...
    const effectiveOccupantsByCell =
