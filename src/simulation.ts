import {
  ...
  ACTION_THRESHOLD_REPRODUCE_CAUTIOUSLY,
  ACTION_THRESHOLD_REST
...
const DEFAULT_CONFIG: SimulationConfig = {
  ...
  genomeV2DistanceWeights: {
    ...
    traits: {
      ...
      [ACTION_PRIORITY_HARVEST_SECONDARY]: 0,
      [ACTION_PRIORITY_MOVE_TOWARD_FERTILITY]: 0,
      [ACTION_PRIORITY_REPRODUCE_CAUTIOUSLY]: 0,
      [ACTION_PRIORITY_REST]: 0,
      [ACTION_THRESHOLD_HARVEST_PRIMARY]: 0,
      [ACTION_THRESHOLD_HARVEST_SECONDARY]: 0,
      [ACTION_THRESHOLD_MOVE_TOWARD_FERTILITY]: 0,
      [ACTION_THRESHOLD_REPRODUCE_CAUTIOUSLY]: 0,
      [ACTION_THRESHOLD_REST]: 0
    }
  },
  maxAge: 120
};
